...
<body style="background-color:powderblue;">
    ...
    <div class="row">
        <div class="col-lg-4 mb-4">
            <div class="card" style="height:21rem; width: 18rem; margin-left:90px; margin-top:40px">
                <class="card-img-top"><img src="images\htmll.png" class="learn">
                    <div class="card-body">
                        <h3 class="card-text">
                        <div class="dropdown">
                           <a class="btn btn-primary" style="width:15rem; font-size:20px; font-color:white;">
                                HTML Quiz </a>
                                <div class="dropdown-content">
                                <!-- dropdown -->
                                <a href="http://localhost/quiz_app/quiz_html_beg.php" target=_blank>Easy</a>
                                <a href="http://localhost/quiz_app/quiz_html_inter.php" target=_blank>Difficult</option></a>
                            </div>
                        </div>
            ...
            <class="card-img-top"><img src="images\css1.jpg" class="learn">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" style="width:15rem; font-size:20px; font-color:white;">
                                ...
                                <div class="dropdown-content">
                                <!-- dropdown -->
                                <a href="http://localhost/quiz_app/css_quiz_beg.php" target=_blank>Easy</a>
                                <a href="http://localhost/quiz_app/css_quiz_inter.php" target=_blank>Difficult</option></a>
            ...
            <class="card-img-top"><img src="images\php.jpg" class="learn">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" style="width:15rem; font-size:20px; font-color:white;">
                                ...
                                <div class="dropdown-content">
                                <!-- dropdown -->
                                <a href="http://localhost/quiz_app/quiz_python_beg.php" target=_blank>Easy</a>
                                <a href="http://localhost/quiz_app/quiz_python_inter.php" target=_blank>Difficult</option></a>
                            </div>
                        </div>
                        </h3>
                    </div>
                    ...
                    <div class="div4">
                        <ul class="sci">
                            ...
                            <p><a class="btn btn-link btn-floating btn-lg text-dar m-1" role="button"
                                    href="https://www.facebook.com/" target="_blank"><img src="https://www.pngkit.com/png/detail/196-1967191_facebook-logo-png-image-facebook-logo-vector-png.png"
