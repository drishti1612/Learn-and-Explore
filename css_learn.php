...
<body style="background-color:powderblue;">
    ...
    <div>
        <a href="https://www.w3schools.com/w3css/defaulT.asp" class="a">1.CSS Tutorial 1(Documentation</a><br><br>
        <a href="https://www.geeksforgeeks.org/css-tutorials/" class="a">2.CSS Tutorial 2 (Documentation)</a><br><br>
        <a href="https://youtube.com/playlist?list=PLx_KyK8sU66WADyw7TY_LKwlFXB5JXcxA" class="a">3.CSS Tutorial 3(video)</a><br><br>
        <a href="https://youtu.be/Edsxf_NBFrw" class="a">4.CSS Tutorial 4(video)</a><br><br>
        <a href="https://youtu.be/WyxzAU3p8CE" class="a">5.CSS Tutorial 5 (video)</a><br><br>
        <a href="https://www.codecademy.com/learn/learn-css" class="a">6.CSS Tutorial 6 (documentation)</a><br><br>
<!--End of tutorial list-->
    <!-- Footer-->
    <?php include("footer.php"); ?>
    <!-- end of footer-->    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js"
