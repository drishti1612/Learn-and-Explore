...
<body style="background-color:powderblue;">
    ...
    <div>
        <a href="https://youtu.be/rfscVS0vtbw" class="a">Python Tutorial Crash Course 1 (Video)</a><br><br>
        <a href="https://youtube.com/playlist?list=PLsyeobzWxl7poL9JTVyndKe62ieoN-MZ3" class="a">Python Tutorial Playlist 2 (Video)</a><br><br>
        <a href="https://youtu.be/t8pPdKYpowI" class="a">Python Tutorial for Beginners (Video)</a><br><br>
        <a href="https://www.geeksforgeeks.org/python-programming-language/" class="a">Complete Python Tutorial Under one Roof (Documentation)</a><br><br>
        <a href="https://www.w3schools.com/python/" class="a">Python Tutorial 5 (Documentation)</a><br><br>
        <a href="https://www.python.org/" class="a">Python Tutorial 6 (Documentation)</a><br><br>
    </div>
